...
Usage:
cd sheeprl
diambra run python agent-ppo.py --cfg_path "./example-logs/runs/ppo/doapp/experiment/version_0/config.yaml" --checkpoint_path "./example-logs/runs/ppo/doapp/experiment/version_0/checkpoint/ckpt_1024_0.ckpt"
"""
